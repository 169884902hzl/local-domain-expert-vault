...
def build_packet(candidate_id: str, *, run_id: str = "", dry_run: bool = False) -> dict:
    ...
    payload = {"schema_version": "evidence_packet.v1", "candidate_id": candidate_id, "run_id": run_id, "packet_status": "draft", "created_at": utc_now(), "core_evidence": candidate.get("draft_evidence", []), "human_confirmed": False, "confirmed_by": "", "confirmed_at": "", "artifact_hashes": [], "boundary": "Draft evidence packet; scheduled automation cannot use it for active commit."}
