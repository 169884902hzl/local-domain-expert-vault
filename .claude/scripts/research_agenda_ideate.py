...
MECHANISM_SPECS = [
    ...
    },
    {
        ...
        "keywords": ["vla", "action interface", "rl token", "constraint", "geometry", "contact", "planning", "intent", "local constraint", "trajectory", "long-horizon"],
        "strong_keywords": ["vla", "action interface", "rl token", "constraint", "geometry", "planning", "intent", "local constraint", "trajectory", "long-horizon"],
        "priority": 6,
    ...
    *,
    ...
    packet = {
        ...
        "rules": [
            ...
            "Treat these as the four core paper research axes: VLA/VLM/RL-token/action-interface, tactile/force/contact-rich manipulation, Sim-to-Real/robustness/failure recovery, and DLO/bimanual manipulation. Strong candidates should name which axes they use and why; they do not need to use all four.",
            ...
            "Do not deliberately avoid VLA/RL-token/Sim-to-Real when the evidence supports them; instead avoid generic VLA, generic RL-token, or generic Sim-to-Real framing that lacks a concrete interface, physical feedback path, robustness mechanism, or DLO/bimanual test.",
        ...
        "free_divergence_policy": {
            ...
            "boundary": "Use the four core axes as first-class paper directions, but never as generic labels or forced topic dressing.",
            "instruction": "Use focus tracks as optional background only. They must not dominate candidate selection. Prefer the strongest engineering pathology and the clearest research axis intersection over historical user curiosity.",
        },
        "quality_target": {
            ...
            "prefer": [
                ...
                "clear use of one or more core axes: VLA/RL-token/action interface, tactile/force/contact-rich manipulation, Sim-to-Real/robustness/failure recovery, or DLO/bimanual manipulation",
                "lab-fit advantage using Franka, bimanual setup, wrist cameras, FlexiTac, or DLO/cable tasks when relevant to the paper claim",
            ],
            "avoid": [
    ...
    *,
    ...
    packet["rules"].extend(
        [
            ...
            "Keep the four paper axes visible when relevant: VLA/RL-token/action interface, tactile/force/contact-rich manipulation, Sim-to-Real/robustness/failure recovery, and DLO/bimanual manipulation.",
