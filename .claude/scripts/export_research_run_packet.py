...
from research_seed_v2_common import artifact_dir, publish_dir, read_json, run_dir, v2_rel, write_json
...
DROP_KEYS = {"payload", "raw_payload", "cache_payload", "request_headers", "api_key", "authorization", "source_pdf"}
