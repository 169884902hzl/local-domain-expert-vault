---
title: "NCP Contact Model"
tags: [physics-simulation, contact-mechanics, optimization]
created: "2026-05-16"
updated: "2026-05-16"
type: "concept"
status: "done"
summary: "基于非线性互补问题（NCP）的接触约束建模方法，支持 Signorini-Coulomb 摩擦定律。"
---

## Definition

NCP Contact Model is maintained here as an evidence-linked concept. 基于非线性互补问题（NCP）的接触约束建模方法，支持 Signorini-Coulomb 摩擦定律。

## Key Ideas

- Direct local evidence currently comes from [[luo2026flash]].
- The concept is tracked with local tags: physics-simulation, contact-mechanics, optimization.
...
- Broader local evidence context: [[luo2026flash]], [[yang2026automated]], [[yang2026physforge]], [[xu2026r2rgen]], [[xiao2026worldenv]].
