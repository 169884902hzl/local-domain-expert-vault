...
type: "concept"
status: "done"
summary: "Vision-Language-Action 模型，将视觉感知、语言理解和动作生成统一在一个端到端框架中。"
---

## Definition

视觉-语言-动作模型 (VLA) is maintained here as an evidence-linked concept. Vision-Language-Action 模型，将视觉感知、语言理解和动作生成统一在一个端到端框架中。

## Key Ideas

- Direct local evidence currently comes from [[li2026gazevla]].
- The concept is tracked with local tags: VLA, robot-learning, foundation-model.
...
- Broader local evidence context: [[li2026gazevla]], [[zheng2026pokevla]], [[zhang2026visionlanguageaction]], [[zeng2026recapa]], [[yang2026asyncshield]].
