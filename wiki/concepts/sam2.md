---
title: "SAM2"
tags: [concept, segmentation, foundation-model]
created: "2026-05-06"
updated: "2026-05-06"
type: "concept"
status: "done"
summary: "Segment Anything Model 2，Meta 开发的通用图像和视频分割基础模型，支持实时视频流中的物体分割。"
---

## Definition

SAM2 is maintained here as an evidence-linked concept. Segment Anything Model 2，Meta 开发的通用图像和视频分割基础模型，支持实时视频流中的物体分割。

## Key Ideas

- Direct local evidence currently comes from [[zhou2026rcnf]].
- The concept is tracked with local tags: concept, segmentation, foundation-model.
...
- Broader local evidence context: [[zhou2026rcnf]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]], [[zhou2025oneshot]].
