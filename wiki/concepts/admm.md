...
type: "concept"
status: "done"
summary: "Alternating Direction Method of Multipliers，一种分布式优化算法，可将大规模问题分解为多个可并行求解的子问题"
---

## Definition

ADMM is maintained here as an evidence-linked concept. Alternating Direction Method of Multipliers，一种分布式优化算法，可将大规模问题分解为多个可并行求解的子问题

## Key Ideas

- Direct local evidence currently comes from [[yu2026atrs]].
- The concept is tracked with local tags: concept, optimization.
...
- Broader local evidence context: [[yu2026atrs]], [[zhu2024scaling]], [[zhou2025oneshot]], [[zhi2025closedloop]], [[zhi102unifying]].
