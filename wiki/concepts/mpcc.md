---
title: "MPCC (Mathematical Programs with Complementarity Constraints)"
tags: [optimization, complementarity, contact]
created: "2026-05-12"
updated: "2026-05-12"
type: "concept"
status: "done"
summary: "带互补约束的数学规划，是 CITO 的标准数学形式，在可行点处标准约束条件失效导致数值病态。"
---

## Definition

MPCC (Mathematical Programs with Complementarity Constraints) is maintained here as an evidence-linked concept. 带互补约束的数学规划，是 CITO 的标准数学形式，在可行点处标准约束条件失效导致数值病态。

## Key Ideas

- Direct local evidence currently comes from no direct backlink yet.
- The concept is tracked with local tags: optimization, complementarity, contact.
...
- Broader local evidence context: [[li2026impact]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]], [[zhou2026sim1]].
