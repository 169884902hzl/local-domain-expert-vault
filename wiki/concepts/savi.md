---
title: "SAVi (Slot Attention for Video)"
tags: [object-centric, video-prediction, representation-learning]
created: "2026-05-15"
updated: "2026-05-15"
type: "concept"
status: "done"
summary: "递归式Slot Attention视频模型，逐帧将视频解析为时间对齐的对象slot表征，用于对象中心视频预测。"
---

## Definition

SAVi (Slot Attention for Video) is maintained here as an evidence-linked concept. 递归式Slot Attention视频模型，逐帧将视频解析为时间对齐的对象slot表征，用于对象中心视频预测。

## Key Ideas

- Direct local evidence currently comes from [[spieler2026slotmpc]].
- The concept is tracked with local tags: object-centric, video-prediction, representation-learning.
...
- [[ghosh2026reducing]] (broader context): ROVED 框架通过 VLE 生成偏好标签、不确定性过滤选择性地查询 oracle，并在训练中参数高效微调 VLE，在 Meta-World 操控任务上减少 50-80% o...
...
- Broader local evidence context: [[spieler2026slotmpc]], [[ghosh2026reducing]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhu2024scaling]].
