---
title: "MIQCP"
tags: [planning, optimization, mixed-integer]
created: "2026-05-12"
updated: "2026-05-12"
type: "concept"
status: "done"
summary: "混合整数二次约束规划，用于联合优化离散模式选择和连续路径规划。"
---

## Definition

MIQCP is maintained here as an evidence-linked concept. 混合整数二次约束规划，用于联合优化离散模式选择和连续路径规划。

## Key Ideas

- Direct local evidence currently comes from [[schperberg2026mobius]].
- The concept is tracked with local tags: planning, optimization, mixed-integer.
...
- Broader local evidence context: [[schperberg2026mobius]], [[zhou2026rcnf]], [[zhou2025oneshot]], [[zhang2026prts]], [[zeng2026recapa]].
