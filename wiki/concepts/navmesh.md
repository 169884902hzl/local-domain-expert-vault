---
title: "NavMesh"
tags: [planning, navigation, simulation]
created: "2026-05-13"
updated: "2026-05-13"
type: "concept"
status: "done"
summary: "NavMesh（导航网格）编码环境中可通行表面的网格表示，用于路径规划和碰撞检测。"
---

## Definition

NavMesh is maintained here as an evidence-linked concept. NavMesh（导航网格）编码环境中可通行表面的网格表示，用于路径规划和碰撞检测。

## Key Ideas

- Direct local evidence currently comes from [[wei2026navol]].
- The concept is tracked with local tags: planning, navigation, simulation.
...
- Broader local evidence context: [[wei2026navol]], [[zhou2026rcnf]], [[zhou2025oneshot]], [[zhang2026prts]], [[zeng2026recapa]].
