---
title: "RECAP"
tags: [RL, VLA, advantage-conditioned, offline-RL]
created: "2026-05-07"
updated: "2026-05-07"
type: "concept"
status: "done"
summary: "π₀.6 提出的 advantage-conditioned offline RL 方法，对 VLA 进行 advantage 条件化微调以提升操控鲁棒性，RISE 的 Policy Warm-up 阶段主要遵循其训练流程。"
---

## Definition

RECAP is maintained here as an evidence-linked concept. π₀.6 提出的 advantage-conditioned offline RL 方法，对 VLA 进行 advantage 条件化微调以提升操控鲁棒性，RISE 的 Policy Warm-up 阶段主要遵循其训练流程。

## Key Ideas

- Direct local evidence currently comes from [[yang2026rise]].
- The concept is tracked with local tags: RL, VLA, advantage-conditioned, offline-RL.
...
- Broader local evidence context: [[yang2026rise]], [[zhu2026nsvla]], [[zhong2026vlaopd]], [[zhao2026visualtactile]], [[zhang2026world2minecraft]].
