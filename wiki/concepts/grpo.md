...
type: "concept"
status: "done"
summary: "Group Relative Policy Optimization，一种基于组内相对回报比较的强化学习策略优化方法，用于VLA模型微调。"
---

## Definition

GRPO is maintained here as an evidence-linked concept. Group Relative Policy Optimization，一种基于组内相对回报比较的强化学习策略优化方法，用于VLA模型微调。
...
- Broader local evidence context: [[jin2026grounding]], [[jie2026omnivlarl]], [[zhu2024scaling]], [[zhou2025oneshot]], [[zhi2025closedloop]].
