---
title: "CTMC (Continuous-Time Markov Chain)"
tags: [markov-process, generative-model, stochastic-process]
created: "2026-05-13"
updated: "2026-05-13"
type: "concept"
status: "done"
summary: "连续时间马尔可夫链，由速率矩阵（生成器）定义，状态转移可发生在任意连续时间点，是离散 flow matching 的核心动力学载体。"
---

## Definition

CTMC (Continuous-Time Markov Chain) is maintained here as an evidence-linked concept. 连续时间马尔可夫链，由速率矩阵（生成器）定义，状态转移可发生在任意连续时间点，是离散 flow matching 的核心动力学载体。

## Key Ideas

- Direct local evidence currently comes from no direct backlink yet.
- The concept is tracked with local tags: markov-process, generative-model, stochastic-process.
...
- Broader local evidence context: [[khan2026discrete]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]].
