...
tags: [neuro-symbolic, learning-method, reasoning]
created: "2026-05-03"
updated: "2026-05-03"
type: "concept"
status: "done"
summary: "结合神经网络模式识别与符号推理的方法，提升组合性、可解释性和可验证性"
---

## Definition

Neuro-Symbolic Learning is maintained here as an evidence-linked concept. 结合神经网络模式识别与符号推理的方法，提升组合性、可解释性和可验证性

## Key Ideas

- Direct local evidence currently comes from [[zhu2026nsvla]].
- The concept is tracked with local tags: neuro-symbolic, learning-method, reasoning.
...
- Broader local evidence context: [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2025oneshot]], [[zhong2026vlaopd]], [[zheng2026pokevla]].
