---
title: "RLHF"
tags: [concept, RL, alignment]
created: "2026-05-13"
updated: "2026-05-13"
type: "concept"
status: "done"
summary: "Reinforcement Learning from Human Feedback，利用人类偏好信号训练奖励模型并用于策略优化的方法"
---

## Definition

RLHF is maintained here as an evidence-linked concept. Reinforcement Learning from Human Feedback，利用人类偏好信号训练奖励模型并用于策略优化的方法

## Key Ideas

- Direct local evidence currently comes from [[li2026hpedit]].
- The concept is tracked with local tags: concept, RL, alignment.
...
- [[li2026hpedit]] (direct evidence): 提出 HP-Edit 框架，利用 VLM 训练的 HP-Scorer 作为任务感知奖励函数，结合 Flow-GRPO 对扩散模型图像编辑器进行人类偏好对齐的后训练，在 8 个...
...
- Direct evidence papers: [[li2026hpedit]].
- Broader local evidence context: [[li2026hpedit]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhou2026ego]], [[zhong2026vlaopd]].
