...
tags: [RL, offline-RL, online-RL, post-training]
created: "2026-05-06"
updated: "2026-05-06"
type: "concept"
status: "done"
summary: "先在离线数据上预训练 RL 策略和价值函数，再通过在线交互持续改进，结合离线数据效率和在线适应能力。"
---

## Definition

Offline-to-Online RL is maintained here as an evidence-linked concept. 先在离线数据上预训练 RL 策略和价值函数，再通过在线交互持续改进，结合离线数据效率和在线适应能力。

## Key Ideas

- Direct local evidence currently comes from [[wang2026while]].
- The concept is tracked with local tags: RL, offline-RL, online-RL, post-training.
...
- Broader local evidence context: [[wang2026while]], [[zhong2026vlaopd]], [[yu2026atrs]], [[xu2026twinrlvla]], [[wu2025imperfect]].
