---
title: "Liveness (Control Theory)"
tags: [concept, control-theory]
created: "2026-05-13"
updated: "2026-05-13"
type: "concept"
status: "done"
summary: "控制论中描述系统是否能到达目标集的性质，用于策略评估时转化为语义距离度量"
---

## Definition

Liveness (Control Theory) is maintained here as an evidence-linked concept. 控制论中描述系统是否能到达目标集的性质，用于策略评估时转化为语义距离度量

## Key Ideas

- Direct local evidence currently comes from [[wang2026offline]].
- The concept is tracked with local tags: concept, control-theory.
...
- Broader local evidence context: [[wang2026offline]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]].
