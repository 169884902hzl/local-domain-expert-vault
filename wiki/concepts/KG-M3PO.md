---
title: "KG-M3PO"
tags: [RL, knowledge-graph, multi-task, scene-graph]
created: "2026-05-15"
updated: "2026-05-15"
type: "concept"
status: "done"
summary: "Knowledge-Guided M3PO，将在线3D场景图通过GNN端到端融入RL训练的多任务操控框架"
---

## Definition

KG-M3PO is maintained here as an evidence-linked concept. Knowledge-Guided M3PO，将在线3D场景图通过GNN端到端融入RL训练的多任务操控框架

## Key Ideas

- Direct local evidence currently comes from [[narendra2026knowledgeguided]].
- The concept is tracked with local tags: RL, knowledge-graph, multi-task, scene-graph.
