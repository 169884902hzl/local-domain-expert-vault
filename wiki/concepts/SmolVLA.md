---
title: "SmolVLA"
tags: [VLA, efficiency, asynchronous-execution]
created: "2026-05-13"
updated: "2026-05-13"
type: "concept"
status: "done"
summary: "SmolVLA 是一种轻量级 VLA 模型，通过异步架构解耦视觉编码与策略执行，实现高效实时控制。"
---

## Definition

SmolVLA is maintained here as an evidence-linked concept. SmolVLA 是一种轻量级 VLA 模型，通过异步架构解耦视觉编码与策略执行，实现高效实时控制。

## Key Ideas

- Direct local evidence currently comes from [[feng2026see]].
- The concept is tracked with local tags: VLA, efficiency, asynchronous-execution.
...
- Broader local evidence context: [[feng2026see]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]].
