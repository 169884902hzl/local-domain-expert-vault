...
tags: [generalization, robustness, shortcut-learning]
created: "2026-05-09"
updated: "2026-05-09"
type: "concept"
status: "done"
summary: "模型在训练数据中学到的非因果统计依赖关系，导致分布偏移时泛化性能下降。"
---

## Definition

Spurious Correlation is maintained here as an evidence-linked concept. 模型在训练数据中学到的非因果统计依赖关系，导致分布偏移时泛化性能下降。

## Key Ideas

- Direct local evidence currently comes from [[wu2026contrastive]].
- The concept is tracked with local tags: generalization, robustness, shortcut-learning.
...
- Broader local evidence context: [[wu2026contrastive]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]], [[zhou2026sim1]].
