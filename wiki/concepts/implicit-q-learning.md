...
tags: [RL, offline-RL, value-learning]
created: "2026-05-06"
updated: "2026-05-06"
type: "concept"
status: "done"
summary: "通过不对称 expectile 回归学习状态价值函数，避免显式动作最大化，适合离线 RL。"
---

## Definition

Implicit Q-Learning (IQL) is maintained here as an evidence-linked concept. 通过不对称 expectile 回归学习状态价值函数，避免显式动作最大化，适合离线 RL。

## Key Ideas

- Direct local evidence currently comes from [[wang2026while]].
- The concept is tracked with local tags: RL, offline-RL, value-learning.
...
- Broader local evidence context: [[wang2026while]], [[zhu2026nsvla]], [[zhong2026vlaopd]], [[zhao2026visualtactile]], [[zhang2026safevla]].
