...
type: "concept"
status: "done"
summary: "基于隐空间想象的模型RL方法，联合学习视觉世界模型和策略，需要在线交互和奖励信号。"
---

## Definition

Dreamer-v3 is maintained here as an evidence-linked concept. 基于隐空间想象的模型RL方法，联合学习视觉世界模型和策略，需要在线交互和奖励信号。

## Key Ideas

- Direct local evidence currently comes from [[spieler2026slotmpc]].
- The concept is tracked with local tags: world-model, model-based-RL, reinforcement-learning.
...
- Broader local evidence context: [[spieler2026slotmpc]], [[missal2026ropedreamer]], [[ziakas2026aligning]], [[zhu2026nsvla]], [[zhu2024scaling]].
