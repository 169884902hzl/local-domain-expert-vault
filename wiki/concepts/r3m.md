---
title: "R3M: Universal Visual Representation for Robot Manipulation"
tags: [visual-representation, pre-training, robot-learning]
created: "2026-05-08"
updated: "2026-05-08"
type: "concept"
status: "done"
summary: "基于人类视频自监督预训练的机器人视觉表征方法，使用 ViT 架构学习可迁移到下游操控任务的视觉编码器。"
---

## Definition

R3M: Universal Visual Representation for Robot Manipulation is maintained here as an evidence-linked concept. 基于人类视频自监督预训练的机器人视觉表征方法，使用 ViT 架构学习可迁移到下游操控任务的视觉编码器。

## Key Ideas

- Direct local evidence currently comes from [[li2026h2r]].
- The concept is tracked with local tags: visual-representation, pre-training, robot-learning.
