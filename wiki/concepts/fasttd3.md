---
title: "FastTD3"
tags: [reinforcement-learning, off-policy, parallel-simulation]
created: "2026-05-02"
updated: "2026-05-02"
type: "concept"
status: "done"
summary: "TD3 的大规模并行仿真变体，引入大 batch 训练、分布式 critic 和混合探索噪声，在稀疏奖励大规模并行环境中优于 PPO。"
---

## Definition

FastTD3 is maintained here as an evidence-linked concept. TD3 的大规模并行仿真变体，引入大 batch 训练、分布式 critic 和混合探索噪声，在稀疏奖励大规模并行环境中优于 PPO。

## Key Ideas

- Direct local evidence currently comes from [[xu2026expertgen]].
- The concept is tracked with local tags: reinforcement-learning, off-policy, parallel-simulation.
...
- Broader local evidence context: [[xu2026expertgen]], [[zhu2024scaling]], [[zhou2025oneshot]], [[zhi2025closedloop]], [[zhi102unifying]].
