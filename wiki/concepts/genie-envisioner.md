...
tags: [world-model, video-generation, dynamics-model]
created: "2026-05-07"
updated: "2026-05-07"
type: "concept"
status: "done"
summary: "基于 LTX-Video 架构的机器人操控视频生成世界模型，支持 action-conditioned 多视角预测，RISE 的 dynamics model 基础架构。"
---

## Definition

Genie Envisioner is maintained here as an evidence-linked concept. 基于 LTX-Video 架构的机器人操控视频生成世界模型，支持 action-conditioned 多视角预测，RISE 的 dynamics model 基础架构。

## Key Ideas

- Direct local evidence currently comes from [[yang2026rise]].
- The concept is tracked with local tags: world-model, video-generation, dynamics-model.
...
- Broader local evidence context: [[yang2026rise]], [[zhu2026nsvla]], [[zhu2024scaling]], [[zhou2026vlbiman]], [[zhou2026rcnf]].
