---
title: "RoboPilot"
tags: [concept, teleoperation]
created: "2026-05-07"
updated: "2026-05-07"
type: "concept"
status: "done"
summary: "基于 26 面标记手柄的低成本遥操作系统，$50 即可实现全远程双臂移动操控数据采集，数据质量与 VR 相当"
---

## Definition

RoboPilot is maintained here as an evidence-linked concept. 基于 26 面标记手柄的低成本遥操作系统，$50 即可实现全远程双臂移动操控数据采集，数据质量与 VR 相当

## Key Ideas

- Direct local evidence currently comes from [[cui2026aharobot]].
- The concept is tracked with local tags: concept, teleoperation.
