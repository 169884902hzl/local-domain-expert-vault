...
tags: [concept, RL, imitation-learning]
created: "2026-05-06"
updated: "2026-05-06"
type: "concept"
status: "done"
summary: "从专家演示中推断潜在奖励函数的方法，区别于直接模仿行为的行为克隆"
---

## Definition

Inverse Reinforcement Learning is maintained here as an evidence-linked concept. 从专家演示中推断潜在奖励函数的方法，区别于直接模仿行为的行为克隆

## Key Ideas

- Direct local evidence currently comes from [[ji2026recovering]].
- The concept is tracked with local tags: concept, RL, imitation-learning.
...
- Broader local evidence context: [[ji2026recovering]], [[zhao2026visualtactile]], [[zhu2026nsvla]], [[zhong2026vlaopd]], [[zhang2026safevla]].
